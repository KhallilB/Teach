...
function enableVideo() {
  ...
  document.getElementById('remotes').style.visibility =
    'visible';
  loadSimpleWebRTC();
}
...
function loadSimpleWebRTC() {
  ...
  script.onload = function() {
    ...
    webrtc.on('localStream', function(stream) {
      ...
      document.getElementById('localVolume').style.display =
        'block';
    });
    ...
    webrtc.on('localMediaError', function(err) {
      alert(
        'This service only works if you allow camera access.Please grant access and refresh the page.'
      );
    });
    ...
    webrtc.on('volumeChange', function(volume, treshold) {
      showVolume(
        document.getElementById('localVolume'),
        volume
      );
    });
    ...
    webrtc.on('remoteVolumeChange', function(peer, volume) {
      showVolume(
        document.getElementById('volume_' + peer.id),
        volume
      );
    });
    ...
    webrtc.on('iceFailed', function(peer) {
      var connstate = document.querySelector(
        '#container_' +
